...
class FileUpload
{
     ...
     * 
     * @param array   $uploadParams             Upload params
     */
     ...
     * 
     * @throw FileUploadException   Throws exception if storage type is undefined
     * 
     * @return FileUpload
     */
    ...
    final function getUploadFolder()
    {
        return $this->_folder .
            DIRECTORY_SEPARATOR .
            ($this->_treeStructure ? $this->getTreeStructureMap() : "") .
            DIRECTORY_SEPARATOR;
    }
